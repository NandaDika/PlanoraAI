        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                ...
                <p class="text-indigo-300">
                    Mulai perjalanan Anda dengan PlanoraAI
                </p>
            </div>
            ...
            <div class="bg-indigo-900/50 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-indigo-800/30">
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <!-- Name -->
                    <div>
                        <x-input-label for="name" :value="__('Name')" class="text-white font-semibold mb-2" />
                        <x-text-input
                            id="name"
                    ...
                    <!-- Confirm Password -->
                    <div>
                        <x-input-label for="password_confirmation" :value="__('Confirm Password')" class="text-white font-semibold mb-2" />
                        <x-text-input
                ...
                <div class="mt-6 text-center">
                    <p class="text-indigo-300 text-sm">
                        Sudah punya akun?
                        <a href="{{ route('login') }}" class="text-white font-semibold hover:text-indigo-200 transition">
                            Masuk di sini
                        </a>
                    </p>
                </div>
            ...
            <!-- Terms -->
            <p class="text-center text-indigo-400 text-xs mt-4">
                Dengan mendaftar, Anda menyetujui
                <a href="#" class="text-indigo-300 hover:text-white underline">Syarat & Ketentuan</a>
                serta
                <a href="#" class="text-indigo-300 hover:text-white underline">Kebijakan Privasi</a>
                kami
            </p>
        </div>
    </div>
